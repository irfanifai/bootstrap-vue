<template>
  <b-container>
    <b-button
      v-b-popover.hover.top="'My first popover content'"
      title="Popover"
    >
      First popover
    </b-button>
    ...
    <b-button id="popover-target-1"> Hover me - target 1 </b-button>
    ...
    <b-button id="popover-target-2" variant="primary">
      Hover me - target 2
    </b-button>
    <b-popover
    ...
    <div class="p-2">
      <b-button class="px-1 mr-2" @click="onOpen"> Open </b-button>
