<template>
  <b-container>
    ...
    <b-button @click="$bvModal.show('bv-modal-sample')"
      >Open Modal with $bvModal</b-button
    >
    ...
    <b-modal ref="modal-3" hide-footer title="Using $refs to be open">
      ...
      <b-button @click="hideModal3" block variant="outline-danger"
        >Close me</b-button
      >
      <b-button @click="toggleModal3" block variant="outline-warning"
        >Toggle me</b-button
      >
    </b-modal>
